...
import { getSingleCourses } from "../../actions/course";
...
const SingleCourse = ({ match }) => {
    ...
    useEffect(() => {
        if(courseIdValidator(params.id)) dispatch(getSingleCourses(params.id));
    }, [])
    if(!courseIdValidator(params.id)) return <Navigate to="/404" />
    return (
        <Fragment>
